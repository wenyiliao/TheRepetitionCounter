...
file_path="C:\\Users\\WinnieLiao\\Desktop\\TheRepetitonCounter_PC"
cam_idx=0
...
class rep_detect():
    def __init__(self,window,mode):
        ...
        self.interpreter = tf.lite.Interpreter(model_path=file_path+"\\movenet.tflite")
        ...
        if mode==1:
            image = Image.open(file_path+"\\mode1.png")
            ...
            # Create a button
            image = Image.open(file_path+"\\overhead_press.png").resize((100,115))
            ...
            image = Image.open(file_path+"\\side_leg_raise.png").resize((100,115))
            ...
            def start():
                ...
                def give_up():
                    ...
                    image = Image.open(file_path+"\\fail.png")
                ...
                image = Image.open(file_path+"\\mode2.png")
                self.bg_image = ImageTk.PhotoImage(image)
            ...
            image = Image.open(file_path+"\\goal.png")
            bg_image = ImageTk.PhotoImage(image)
            ...
            image = Image.open(file_path+"\\overhead_press.png").resize((120,175))
            self.overhead_press_img = ImageTk.PhotoImage(image)
            ...
            image = Image.open(file_path+"\\side_leg_raise.png").resize((130,175))
            self.side_leg_raise_img = ImageTk.PhotoImage(image)
        ...
        if ret:
            ...
            if self.mode==2:
                ...
                if int(self.user_goal)<=self.num:
                    ...
                    image = Image.open(file_path+"\\success.png")
                    self.bg_image = ImageTk.PhotoImage(image)
...
image = Image.open(file_path+"\\background.png")
bg_image = ImageTk.PhotoImage(image)
...
btn_count_img=ImageTk.PhotoImage(file=file_path+"\\btn_count.png")
...
btn_goal_img = ImageTk.PhotoImage(file=file_path+"\\btn_goal.png")
